...
{
    [Fact]
    public void HttpFunction_以HttpContext的內容來判斷要求是不是符合功能()
    {
        // Arrange
    ...
    [Fact]
    public void HttpFunction_如果沒有任何HttpFeature判斷永遠不符合()
    {
        // Arrange
    ...
    [Fact]
    public void HttpFunction_只要任何一個HttpFeature符合就會判斷符合()
    {
        // Arrange
